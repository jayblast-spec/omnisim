...
export const metadata: Metadata = {
  ...
  description: "Choose your simulation type. 8 categories powered by 35 global AI agents.",
};
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-8 text-white/40">
            Each simulation type has a tailored intelligence intake form. Fill it in, and 20 global AI agents react to your exact scenario.
          </p>
        </div>
